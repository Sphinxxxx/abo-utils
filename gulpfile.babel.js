...
gulp.task('build', function() {
    return rollup({
        ...
        plugins: [
            ...
            babel({
                ...
                //If imported NPM modules use ES6 features, and thus need transpiling, remove or change this line:
    ...
    .then(gen => {
        ...
        //Extra steps if we need to paste CSS/HTML into the JS code:
        //
        //Option 1: Quite complicated, using Gulp streams (gulp-sass package):
        //
        //  //https://github.com/dlmanning/gulp-sass#basic-usage
        //  gulp.src(entryScript.replace('.js', '.scss'))
        ...
        //
        //Option 2: Just use synchronous Node options:
        //
        ...
        //  
        //  const html = pug.renderFile(entryScript.replace('.js', '.pug'));
        //
